...
io.popen("cd library && wget https://raw.githubusercontent.com/XMAMXSOURCE/XMAMX/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/XMAMXSOURCE/Files_XMAMX/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevXMAMXW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevXMAMXW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevXMAMXW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevXMAMXW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevXMAMXW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevXMAMXW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
tdcli_function ({ID = "SendMessage",chat_id_ = chat_id,reply_to_message_id_ = reply_to_message_id,disable_notification_ = 1,from_background_ = 1,reply_markup_ = nil,input_message_content_ = {ID = "InputMessageText",text_ = text,disable_web_page_preview_ = 1,clear_draft_ = 0,entities_ = {},parse_mode_ = TextParseMode,},}, X_cb, nil)
end
...
tdcli_function ({  ID = request_id,chat_id_ = chat_id,reply_to_message_id_ = reply_to_message_id,disable_notification_ = disable_notification,from_background_ = from_background,reply_markup_ = reply_markup,input_message_content_ = input_message_content,}, callback or X_cb, extra) 
end
local function sendAudio(chat_id,reply_id,audio,title,caption)  
tdcli_function({ID="SendMessage",  chat_id_ = chat_id,  reply_to_message_id_ = reply_id,  disable_notification_ = 0,  from_background_ = 1,  reply_markup_ = nil,  input_message_content_ = {  ID="InputMessageAudio",  audio_ = GetInputFile(audio),  duration_ = '',  title_ = title or '',  performer_ = '',  caption_ = caption or ''  }},X_cb,nil)
end  
local function sendVideo(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, video, duration, width, height, caption, cb, cmd)
local input_message_content = { ID = "InputMessageVideo",  video_ = getInputFile(video),  added_sticker_file_ids_ = {},  duration_ = duration or 0,  width_ = width or 0,  height_ = height or 0,  caption_ = caption}sendRequest('SendMessage', chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, input_message_content, cb, cmd)  
end
function sendDocument(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, document, caption, X_cb, cmd) 
tdcli_function ({ID = "SendMessage",chat_id_ = chat_id,reply_to_message_id_ = reply_to_message_id,disable_notification_ = disable_notification,from_background_ = from_background,reply_markup_ = reply_markup,input_message_content_ = {ID = "InputMessageDocument",document_ = getInputFile(document),caption_ = caption},}, X_cb, cmd) 
end
...
tdcli_function ({ ID = "SendMessage",   chat_id_ = chat_id,   reply_to_message_id_ = reply_to_message_id,   disable_notification_ = disable_notification,   from_background_ = from_background,   reply_markup_ = reply_markup,   input_message_content_ = {   ID = "InputMessagePhoto",   photo_ = getInputFile(photo),   added_sticker_file_ids_ = {},   width_ = 0,   height_ = 0,   caption_ = caption  },   }, X_cb, nil)  
end
function Reply_Status(msg,user_id,status,text)
tdcli_function ({ID = "GetUser",user_id_ = user_id},function(arg,data) 
if data.first_name_ ~= false then
local UserName = (data.username_ or "lllEll2")
...
XMAMX_Msg = 'بعد يرادلك' 
elseif msgs < 400 then 
XMAMX_Msg = 'متوسط' 
elseif msgs < 700 then 
XMAMX_Msg = 'بديت تتفاعل' 
elseif msgs < 1200 then 
XMAMX_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
XMAMX_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
XMAMX_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
XMAMX_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
XMAMX_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
XMAMX_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
XMAMX_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
XMAMX_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
XMAMX_Msg = 'رب التفاعل'  
end 
return XMAMX_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceXMAMX(msg,data) -- بداية العمل 
if msg then
...
local list = database:smembers(bot_id.."XMAMX1:List:Filter"..sl)
...
if not DevXMAMXW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevXMAMXW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,XMAMX_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌁' and DevXMAMXW(msg) then  
...
if text == 'تعطيل التواصل ⌁' and DevXMAMXW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌁' and DevXMAMXW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌁' and DevXMAMXW(msg) then  
...
if text == 'ضع كليشه ستارت ⌁' and DevXMAMXW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *❈│ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌁' and DevXMAMXW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *❈│تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌁' and DevXMAMXW(msg) then 
...
if text == 'تحديث السورس ⌁' and DevXMAMXW(msg) then 
os.execute('rm -rf XMAMX.lua')
os.execute('wget https://raw.githubusercontent.com/XMAMXSOURCE/XMAMX/main/XMAMX.lua')
send(msg.chat_id_, msg.id_,' *❈│تم تحديث السورس* \n*❈│لديك اخر اصدار لسورس اكس*\n*❈│الاصدار » { 1.0v}*')
dofile('XMAMX.lua')  
end
if text == 'الاصدار ⌁' and DevXMAMXW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *❈│اصدار سورس اكس* \n*❈│الاصدار »{ 1.0v}*')
end
if text == 'قناه تحديثات البوت ⌁' and DevXMAMXW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❈│[تحديثات البوت](t.me/lllEll2) \n❈│[قناه السورس](t.me/lllEll4)')
end
if text == "ضع اسم للبوت ⌁" and DevXMAMXW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *❈│ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌁' and DevXMAMXW(msg) then 
...
if text == 'المشتركين ⌁' and DevXMAMXW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❈│المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌁' and DevXMAMXW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❈│الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌁") and DevXMAMXW(msg) then
...
if text == ("قائمه العام ⌁") and DevXMAMXW(msg) then
...
if text == ("قائمه الكتم العام ⌁") and DevXMAMXW(msg) then
...
if text=="اذاعه خاص ⌁" and msg.reply_to_message_id_ == 0 and DevXMAMXW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈│ارسل الان اذاعتك؟* \n*❈│للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌁" and msg.reply_to_message_id_ == 0 and DevXMAMXW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈│ارسل الان اذاعتك؟* \n*❈│للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌁" and msg.reply_to_message_id_ == 0 and DevXMAMXW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈│ارسل الان اذاعتك؟* \n*❈│للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌁" and msg.reply_to_message_id_ == 0  and DevXMAMXW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈│ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌁" and msg.reply_to_message_id_ == 0  and DevXMAMXW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈│ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌁' and DevXMAMXW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌁" and DevXMAMXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌁" and DevXMAMXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*❈│عدد الكروبات الان » { '..#group..' }'..XMAMXk..''..XMAMX..'*\n*❈│الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevXMAMXW(msg) then
...
usertext = '*\n ❈│اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'lllEll2')..')'
status  = '\n *❈│تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevXMAMXW(msg) then
...
usertext = '\n *❈│اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll2')..')'
status  = '\n*❈│تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevXMAMXW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevXMAMXW(msg) then
...
local XMAMX1_Msg = database:get(bot_id.."XMAMX1:Add:Filter:Rp2"..text..msg.chat_id_)   
if XMAMX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❈│اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'lllEll2')..') \n ❈│'..XMAMX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if XMAMX_Msg and not Special(msg) then  
local XMAMX_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if XMAMX_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *❈│العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n❈│["..XMAMX_Msg.."] \n")
else
send(msg.chat_id_,0," *❈│العضو :* {["..data.first_name_.."](t.me/lllEll2)}\n❈│["..XMAMX_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *❈│عذرا ⇎* {["..data.first_name_.."](t.me/lllEll2)}\n*❈│عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevXMAMXW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevXMAMXW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevXMAMXW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❈│حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevXMAMXW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❈│حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌁" and DevXMAMXW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *❈│تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌁$") and DevXMAMXW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❈│حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌁" and DevXMAMXW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌁" and DevXMAMXW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *❈│تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌁" and DevXMAMXW(msg) then  
...
database:sadd(bot_id.."XMAMX:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."XMAMX:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_XMAMX = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_XMAMX then 
names_XMAMX = database:smembers(bot_id.."XMAMX:blocname"..msg.chat_id_) or ""
if names_XMAMX and names_XMAMX[1] then 
for i=1,#names_XMAMX do 
if name_XMAMX:match("(.*)("..names_XMAMX[i]..")(.*)") then 
...
database:set(bot_id.."XMAMX:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."XMAMX:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."XMAMX:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."XMAMX:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."XMAMX:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_XMAMXa_new(XMAMX1,XMAMX2)
if XMAMX2 and XMAMX2.first_name_ then 
if XMAMX2.first_name_:match("(.*)"..database:get(bot_id.."XMAMX:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."XMAMX:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local XMAMX_nnn = database:get(bot_id.."XMAMX:nump"..msg.chat_id_) or 5
local XMAMX_nnn2 = database:get(bot_id.."XMAMX:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(XMAMX_nnn2) == tonumber(XMAMX_nnn) or tonumber(XMAMX_nnn2) > tonumber(XMAMX_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."XMAMX:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❈│عزيزي >>["..XMAMX2.username_.."](https://t.me/"..(XMAMX2.username_ or "lllEll2")..")\n❈│عليك وضع التوحيد ⪼ {"..database:get(bot_id.."XMAMX:teh"..msg.chat_id_).."} بجانب اسمك\n❈│عدد المحاولات المتبقيه {"..(tonumber(XMAMX_nnn) - tonumber(XMAMX_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_XMAMXa_new)
end
end
...
local XMAMXChengName = database:get(bot_id.."XMAMX:Cheng:Name"..data.id_)
if not data.first_name_ then 
if XMAMXChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..XMAMXChengName..']')
database:del(bot_id.."XMAMX:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if XMAMXChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."XMAMX:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local XMAMXChengUserName = database:get(bot_id.."XMAMX:Cheng:UserName"..data.id_)
if not data.username_ then 
if XMAMXChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..XMAMXChengUserName..']')
database:del(bot_id.."XMAMX:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if XMAMXChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."XMAMX:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local XMAMXChengPhoto = database:get(bot_id.."XMAMX:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if XMAMXChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."XMAMX:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if XMAMXChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."XMAMX:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
data = JSON.decode(url)
Text = "𓅛 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ χ \n\n[❈│χ ᴄʜᴀɴɴᴇʟ](http://t.me/lllEll2)\n\n[❈│ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/lllEll4)\n\n[❈│χ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/lllEll2)\n\n[❈│ᴛᴡ ʙᴏᴛ ](http://t.me/lllEll22bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓅛︙χ ѕᴏụʀᴄᴇ',url="t.me/lllEll2"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع نسخه الاحتياطيه' and DevXMAMXW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, '*❈│بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'lllEll2')..') \n*❈│تم تفعيل التنظيف التلقائي* ')
return false
end
...
local t = ' \n◊￤تم تفعيل الافلام'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'XMAMX:Movies:XMAMX'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل الافلام'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'XMAMX:Movies:XMAMX'..msg.chat_id_,true)  
end
if text == "فلم" and not database:get(bot_id..'XMAMX:Movies:XMAMX'..msg.chat_id_)  then
local url,res = https.request('https://evzxar.ml/Matrix.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.XMAMX ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'X TEαM .',url="t.me/lllEll2"},
},
}
local msg_id = msg.id_/2097152/0.5
...
local t = ' \n◊￤تم تفعيل المسلسلات'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'XMAMX:Series:XMAMX'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل المسلسلات'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'XMAMX:Series:XMAMX'..msg.chat_id_,true)  
end
if text == "مسلسل" and not database:get(bot_id..'XMAMX:Series:XMAMX'..msg.chat_id_)  then
local url,res = https.request('https://evzxar.ml/Matrix.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.XMAMX ~= true then
Text = "\n*⌯  𝐣𝐨𝐢𝐧 ⁦⤵️*"
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❈│بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'lllEll2')..') \n*❈│تـم قفـل التاك بالكتم* ')
end,nil)   
...
if text == 'تحديث' and DevXMAMXW(msg) then
dofile('XMAMX.lua')  
send(msg.chat_id_, msg.id_, ' *❈│تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevXMAMXW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevXMAMXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if XMAMXSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevXMAMXW(msg) then
...
if XMAMXSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*❈│لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevXMAMXW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevXMAMXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevXMAMXW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevXMAMXW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevXMAMXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevXMAMXW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevXMAMXW(msg) then
...
if text == ("مسح المطورين") and DevXMAMXW(msg) then
...
if text == 'الملفات' and DevXMAMXW(msg) then
t = ' *❈│ملفات السورس اكس ↓*\n*◐•━━━━━━ X ━━━━━━━•◐* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevXMAMXW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/XMAMXSOURCE/Files_XMAMX/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *❈│اهلا بك في متجر ملفات اكس*\n*❈│ملفات السورس ↓*\n*◐•━━━━━━ X ━━━━━━━•◐*\n\n"
local TextE = "\n*◐•━━━━━━ X ━━━━━━━•◐*\n *❈│علامة تعني { ✓ } ملف مفعل*\n *❈│علامة تعني { ✘ } ملف معطل*\n *❈│قناة سورس اكس ↓*\n".." *❈│*[اضغط هنا لدخول](t.me/lllEll2) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevXMAMXW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/XMAMXSOURCE/Files_XMAMX/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('XMAMX.lua')  
else
send(msg.chat_id_, msg.id_," *❈│عذرا الملف لايدعم سورس اكس* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevXMAMXW(msg) then
...
if text == "مسح الملفات" and DevXMAMXW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *❈│تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevXMAMXW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevXMAMXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "lllEll2")
...
function Function_XMAMX(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_XMAMX, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_XMAMX, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *❈│العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll2')..')'
status  = '\n*❈│تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *❈│لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll2')..')'
status  = '\n*❈│تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *❈│اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *❈│العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll2')..')'
...
database:set(bot_id.."XMAMX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."XMAMX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *❈│ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."XMAMX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."XMAMX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."XMAMX1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."XMAMX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *❈│تم منع الكلمه مع التحذير*")  
database:del(bot_id.."XMAMX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."XMAMX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."XMAMX1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."XMAMX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *❈│ارسل الكلمه الان*")  
database:set(bot_id.."XMAMX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."XMAMX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."XMAMX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."XMAMX1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."XMAMX1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."XMAMX1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."XMAMX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."XMAMX1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."XMAMX1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevXMAMXW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *❈│تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevXMAMXW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *❈│اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'lllEll2')..')'..'\n*❈│تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevXMAMXW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevXMAMXW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اكس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'اكس')
local XMAMX_Msg = {
'عمغي ??💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..XMAMX_Msg[math.random(#XMAMX_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevXMAMXW(msg) then 
...
if XMAMXSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevXMAMXW(msg) then 
...
if text == ("ردود المطور") and DevXMAMXW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❈│قائمة ردود المطور \n*◐•━━━━━━ X ━━━━━━━•◐*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevXMAMXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevXMAMXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevXMAMXW(msg) then   
...
if text == 'تعطيل المغادره' and DevXMAMXW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll2')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
XMAMXdx(msg.chat_id_, msg.id_, ' *❈│ايدي المجموعة » ( '..msg.chat_id_..' )*\n*❈│عدد الادمنيه » ( '..data.administrator_count_..' )*\n*❈│عدد المحظورين » ( '..data.kicked_count_..' )*\n*❈│عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevXMAMXW(msg) then
...
{{text = '𓅛 ѕᴏụʀᴄᴇ χ', url="t.me/lllEll2"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ⌁∫ٴ*◐•━━━━━━ X ━━━━━━━•◐*ٴ⌁∫○ٴ\n❈│[X𝙀𝙉𝘿_ѕᴏụʀᴄᴇ](t.me/lllEll2) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⍆ ѕᴏụʀᴄᴇ χ',url="t.me/lllEll2"}},
}
local msg_id = msg.id_/2097152/0.5
 ...
 *⌁ رابط حذف* [Snspchat](https://accounts.XMAMX.com/accounts/login?continue=https%3A%2F%2Faccounts.XMAMX.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
inline = {
{{text = '𓅛 sᴏᴜʀᴄᴇ 𝗌𝗇𝖺𝗉',url='http://t.me/lllEll2'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'اكس')
...
if not database:get(bot_id..'Cick:lov'..msg.chat_id_) then
database:set(bot_id..":"..msg.sender_user_id_..":lov_Bots"..msg.chat_id_,"senXove")
Text = '*ارسل اسمك واسم الشخص الثاني،*  *\n مثال اسد و لبوى*'
send(msg.chat_id_, msg.id_,Text) 
end
end
if text and text ~="نسبه الحب" and database:get(bot_id..":"..msg.sender_user_id_..":lov_Bots"..msg.chat_id_) == "senXove" then
...
XMAMX = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(XMAMX)
...
--------------------------------------------------------------------------------------------------------------
SourceXMAMX(data.message_,data)
...
------------------------------------------------------------------------
local XMAMXAbot = database:get(bot_id.."XMAMX1:Add:Filter:Rp2"..text..result.chat_id_)   
if XMAMXAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *❈│العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n❈│["..XMAMXAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local XMAMX1_Msg = database:get(bot_id.."XMAMX1:Add:Filter:Rp2"..text..result.chat_id_)   
if XMAMX1_Msg then
send(msg.chat_id_, msg.id_," ❈│"..XMAMX1_Msg)
