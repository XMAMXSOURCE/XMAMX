...
local RunBot = io.open("XMAMX", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/XMAMX
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr XMAMX.lua
wget "https://raw.githubusercontent.com/XMAMXSOURCE/XMAMX/main/XMAMX.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./XMAMX.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S XMAMX -X kill
screen -S XMAMX ./XMAMX
done
]])
RunTs:close()
end
